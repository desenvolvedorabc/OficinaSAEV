# 📊 Análise de Dados SAEV - Relatório em Markdown (Versão Simplificada)
# Script R para gerar relatório completo em formato Markdown
# Autor: Sistema SAEV
# Data: 2025-07-27

# ============================================================================
# 📦 CARREGAMENTO DE PACOTES BÁSICOS
# ============================================================================

# Configurar mirror CRAN
options(repos = c(CRAN = "https://cran.rstudio.com/"))

# Carregar apenas pacotes essenciais (já instalados)
...
anexos_md <- paste0(
  ...
  "---\n\n",
  "*Relatório gerado automaticamente pelo Sistema SAEV em ", format(Sys.time(), "%d/%m/%Y às %H:%M"), "*\n"
)
...
cat("   💾 Dados CSV: R/dados_*.csv\n")
cat("🎉 Relatório Markdown pronto para visualização!\n")
cat("\n💡 Para visualizar o relatório:\n")
cat("   - Abra o arquivo .md em qualquer editor Markdown\n")
cat("   - Use VS Code, Typora, ou visualize no GitHub\n")
cat("   - Converta para PDF usando pandoc se necessário\n")
